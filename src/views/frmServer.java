            ...
            while (true) {
                try {
                    ...
                    if (cuPhap.equals("/ls")) {
                        ...
                        String stk = ttArr[0];
                        String soCmnd = ttArr[1];
                        dsgd = lsdao.getDSDGBySTK(stk);
                        dskh = khdao.findKhachHangByCMND(soCmnd);
                        if (dsgd.isEmpty() || dskh.isEmpty()) {
                            gn.GuiDuLieu("lsnull", ipClient, 1261);
                        } else {
                            for (LichSuGiaoDich dg: dsgd) {
                                gn.GuiDuLieu(dg.toString(), ipClient, 1261);
                            }
                            for (KhachHang kh: dskh) {
                                gn.GuiDuLieu(kh.toString(), ipClient, 1261);
                            }
                        }

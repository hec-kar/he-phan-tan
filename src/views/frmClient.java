...
public class frmClient extends javax.swing.JFrame {
    ...
    class TableThread extends Thread {
        public void run() {
            mht.addColumn("Ngay rut tien");
            mht.addColumn("So tien rut ra");
        }
    }
...
//                    listMsg.add(dataMsg);
                    ...
                    if (dataMsg.equals("lsnull")) {
                        JOptionPane.showMessageDialog(rootPane, "Khong tim thay lich su giao dich");
                    }
                    
                    if (dataMsg.startsWith("ls")) {
                        String[] lines = dataMsg.split("\n");
                        for (String line : lines) {
                            String[] parts = line.split("[|]");
                            Object[] t = new Object[2];
                            t[0] = parts[0].replace("ls:", "");
                            t[1] = parts[1];
                            mht.addRow(t);
                        }
                    ...
                    if (dataMsg.startsWith("kh")) {
                        String[] lines = dataMsg.split("\n");
                        for (String line : lines) {
                            String[] parts = line.split("[|]");
                            Object[] t = new Object[2];
                            t[0] = parts[0].replace("kh:", "");
                            t[1] = parts[1];
                            list1.add("Ho ten::" + (String) t[0], 0);
                            list1.add("So tien:: " + (String) t[1], 1);
                        }
